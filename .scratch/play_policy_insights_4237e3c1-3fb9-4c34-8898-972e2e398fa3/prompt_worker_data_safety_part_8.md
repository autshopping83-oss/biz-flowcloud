...
- **Data Type**: OTHER_APP_PERFORMANCE
  *Description: Any other app performance data excluding crash log data (e.g., stack traces) and diagnostics (e.g., battery life, loading time, latency, or framerate).*
  - `android/app/src/main/assets/public/assets/index-BMHFFNQZ.js (Pattern: telemetry)`
- `dist/assets/index-PqeuXPtB.js (Pattern: telemetry)`
...
Save final JSON output to `/root/projetos/meu-app/.scratch/play_policy_insights_4237e3c1-3fb9-4c34-8898-972e2e398fa3/worker_data_safety_part_8.json`.
