...
- **Data Type**: WEB_BROWSING_HISTORY
  *Description: Information about the websites a user has visited.*
  - `android/app/src/main/res/layout/activity_main.xml (Pattern: WebView)`
- `dist/assets/index-PqeuXPtB.js (Pattern: loadUrl)`
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `android/app/src/main/assets/public/assets/index-BMHFFNQZ.js (Pattern: .email)`
- `api/auth/callback.js (Pattern: .email)`
- `api/db.js (Pattern: .email)`
- **Data Type**: EMAILS
  *Description: A user’s emails including the email subject line, sender, recipients, and the content of the email.*
  - `api/enviar.js (Pattern: sendMail)`
...
Save final JSON output to `/root/projetos/meu-app/.scratch/play_policy_insights_4237e3c1-3fb9-4c34-8898-972e2e398fa3/worker_data_safety_part_6.json`.
