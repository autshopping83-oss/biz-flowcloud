...
- **Data Type**: PURCHASE_HISTORY
  *Description: Information about purchases or transactions a user has made.*
  - `android/app/src/main/assets/public/assets/Dashboard-DF4sbnRU.js (Pattern: receipt)`
- `android/app/src/main/assets/public/assets/index-BMHFFNQZ.js (Pattern: receipt)`
- `android/app/src/main/assets/public/assets/syncService-DcwUexvy.js (Pattern: receipt)`
...
Save final JSON output to `/root/projetos/meu-app/.scratch/play_policy_insights_4237e3c1-3fb9-4c34-8898-972e2e398fa3/worker_data_safety_part_1.json`.
