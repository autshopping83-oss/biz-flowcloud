...
- **Data Type**: OTHER_MESSAGES
  *Description: Any other types of messages. For example, instant messages or chat content.*
  - `android/app/src/main/assets/public/assets/purify.es-CC4Brkr_.js (Pattern: xmpp)`
- `dist/assets/purify.es-CC4Brkr_.js (Pattern: xmpp)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `android/app/src/main/assets/public/assets/index-BMHFFNQZ.js (Pattern: race)`
- `android/app/src/main/assets/public/assets/index.es-ChRz2rLR.js (Pattern: race)`
- `android/app/src/main/assets/public/assets/web-5aCqmVzT.js (Pattern: race)`
- **Data Type**: CRASH_LOGS
  *Description: Crash log data from your app. For example, the number of times your app has crashed, stack traces, or other information directly related to a crash.*
  - `android/app/src/main/assets/public/assets/index-BMHFFNQZ.js (Pattern: uncaughtException)`
...
Save final JSON output to `/root/projetos/meu-app/.scratch/play_policy_insights_4237e3c1-3fb9-4c34-8898-972e2e398fa3/worker_data_safety_part_4.json`.
